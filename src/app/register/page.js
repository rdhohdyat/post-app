...
const Register = () => {
  return (
    <div className="bg-[#39439D] h-screen overflow-hidden">
      <div className="h-[15%] w-full flex flex-col items-center gap-2 mb-5">
      ...
      <div className="bg-white rounded-t-3xl h-full p-6">
        <h1 className="text-[#39439D] text-2xl mb-2 font-semibold">
          Pendaftaran
        </h1>
        <div className="mb-3">
          <div className="font-semibold text-sm mb-1">Nama Usaha</div>
          <input
            type="text"
        ...
        <p className="text-center">
          Sudah punya akun ? <span className="text-[#39439D]"><Link href="/login">masuk</Link></span>
        </p>
      </div>
    </div>
  );
